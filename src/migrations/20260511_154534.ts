...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_products_product_type" AS ENUM('vinyl', 'cd', 'tshirt');
  CREATE TYPE "public"."enum_products_condition" AS ENUM('new', 'used', 'rare', 'imported', 'sealed', 'collectible');
  CREATE TYPE "public"."enum_orders_status" AS ENUM('pending', 'confirmed', 'paid', 'processing', 'shipped', 'delivered', 'cancelled', 'refunded');
  CREATE TYPE "public"."enum_orders_payment_method" AS ENUM('pix', 'credit_card', 'boleto', 'other');
  CREATE TYPE "public"."enum_orders_payment_status" AS ENUM('unpaid', 'paid', 'refunded', 'chargeback');
  ...
  CREATE TABLE "orders" (
  	...
  	"shipping_address_neighborhood" varchar,
